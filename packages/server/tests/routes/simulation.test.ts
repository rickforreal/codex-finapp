...
describe('POST /api/v1/simulate', () => {
  ...
  it('returns monte carlo response with plausible probability range', async () => {
    ...
    expect(body.monteCarlo.withdrawalPercentileCurvesReal).toBeDefined();
    expect(body.monteCarlo.withdrawalPercentileCurvesReal.p50.length).toBe(360);
    expect(body.monteCarlo.withdrawalP50SeriesReal).toEqual(
      body.monteCarlo.withdrawalPercentileCurvesReal.p50,
    );
